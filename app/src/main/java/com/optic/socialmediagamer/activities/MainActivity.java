...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);
          //realizamos las llamadas de nuestra interfaz
        mTextViewRegister = findViewById(R.id.textViewRegister);
        mTextInputEmail = findViewById(R.id.textInputEmail);
        mTextInputPassword = findViewById(R.id.textInputPassword);
        mButtonLogin = findViewById(R.id.btnLogin);
        mButtonGoogle = findViewById(R.id.btnLoginGoogle);
        //variables para la autenticacion de google y correo

        mAuthProvider = new AuthProvider();
        //se mostrara cada vez que nosotros creemos o ingresemos auna cuenta
    ...
    @Override
    //aqui nos da el incio de sesion, conectando a los componentes de la bdd
    ...
    //estable concexion con el cliente google
    private void signInGoogle() {
        Intent signInIntent = mGoogleSignInClient.getSignInIntent();
        startActivityForResult(signInIntent, REQUEST_CODE_GOOGLE);
    }

//se le hara un llamado al anterior metodo para el inicio de sesion
    @Override
...
//
    private void login() {
        ...
        // se imprimira en consola para saber si esta funcionando
