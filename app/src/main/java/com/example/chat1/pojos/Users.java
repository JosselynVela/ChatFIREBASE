...
public class Users {
    ...
    //estrucutra de informacion para firebase
    ...
    //se debe crear un constructor vacio para q funcione con firebase
    public Users() {
    }

    //creamos nuestro metodo
    public Users(String id, String nombre, String email, String foto, String estado, String fecha, String hora, int solicitudes, int nuevomensaje) {
        this.id = id;
        this.nombre = nombre;
        this.email = email;
        this.foto = foto;
